...
Subscribes to:
  ...
  /rs_corrected_frame/compressed — video frames

Publishes:
  /face_tracked/compressed        — output frames (yaw-cropped for face centering)
...
class FaceTrackerNode(Node):
    def __init__(self):
        ...
        self.create_subscription(CompressedImage, '/rs_corrected_frame/compressed', self._frame_cb, 10)
